...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-300 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-[0_16px_40px_-24px_rgba(37,60,112,0.8)] hover:bg-[color-mix(in_oklch,var(--primary)_86%,white)]",
        outline:
          "border-black/8 bg-white/55 text-foreground hover:border-black/12 hover:bg-white/82 aria-expanded:bg-white aria-expanded:text-foreground",
        secondary:
          "bg-[color-mix(in_oklch,var(--secondary)_78%,white)] text-secondary-foreground hover:bg-[color-mix(in_oklch,var(--secondary)_92%,white)] aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
          "text-muted-foreground hover:bg-white/70 hover:text-foreground aria-expanded:bg-white/80 aria-expanded:text-foreground",
        destructive:
